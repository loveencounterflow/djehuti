...
//.........................................................................................................
  ...
  Intertalk = class Intertalk {
    ...
    //---------------------------------------------------------------------------------------------------------
    on_any(listener) {
      return validate.IT_listener(listener);
    }

    // @_listener_from_receiver null, receiver

      // #---------------------------------------------------------------------------------------------------------
    // _listener_from_receiver: ( $key, receiver ) ->
    //   validate.something receiver
    //   #.......................................................................................................
    //   ### if receiver is a callable, use it; else, try to retrieve a suitably named method and use that: ###
    //   if isa.IT_listener receiver
    //     listener      = receiver
    //   else
    //     listener_name = SYMBOLIC._listener_name_from_key $key
    //     listener0     = receiver[ listener_name ]
    //     unless isa.IT_listener listener0
    //       ### TAINT `typeof` will give some strange results ###
    //       throw new Error \
    //         "expected IT_listener for object property #{rpr listener_name}, got a #{typeof listener0}"
    ...
    _listeners_from_event(ae_event) {
      var listeners;
      listeners = this._listeners_from_key(ae_event.$key);
      return listeners != null ? listeners : [];
    }

    //---------------------------------------------------------------------------------------------------------
    async emit(...P) {
      var $key, ae_event, listener, listeners, results;
      ae_event = new Note(...P);
      ({$key} = ae_event);
      listeners = this._listeners_from_event(ae_event);
