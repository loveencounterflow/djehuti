(function() {
  'use strict';
  var DATOM, Emittery, GUY, Intertalk, alert, debug, echo, get_base_types, get_xemitter_types, help, info, inspect, log, misfit, plain, praise, rpr, urge, warn, whisper;
